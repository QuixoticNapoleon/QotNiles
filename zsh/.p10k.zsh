# Generated by Powerlevel10k configuration wizard on 2025-10-26 at 21:45 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#008181}╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#008181}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#008181}╰─%B%F{#FFC500}$%f%b'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND='#008181'
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#002a2b'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#008282'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#008282'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#002a2b'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND="#871214"
  # typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND="#600c13"
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND="#871214"
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND="#871214"
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#004344
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#003233
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#1c4e4f
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#0e3e3f
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#016163
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#0d5051
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=#225859
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=#FFC600
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='󰓥 %n@%m'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#8affff'
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#004546'
